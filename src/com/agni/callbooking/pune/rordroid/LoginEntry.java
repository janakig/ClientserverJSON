...
public class LoginEntry extends Activity implements OnClickListener{
	...
	public void onClick(View v) {
		...
		switch(v.getId()){
		case R.id.bView:
			Intent i = new Intent(getApplicationContext(), LoginView.class);
			startActivity(i);
			break;
		case R.id.bDelete:
			 try{
				 ...
				 SaveValueLogin ex1 = new SaveValueLogin(this);
				 ex1.open();
